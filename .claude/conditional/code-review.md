...
- **Stale documentation** — README, design docs, ADRs, etc. that no longer match the implementation.
- **Missing tests** — new code paths without corresponding unit AND integration tests.
- **Leaked abstractions** — internal labels, register names, or implementation details exposed in public APIs or test assertions.
